...
#[component]
pub fn SumoRobot() -> impl IntoView {
    view! {
        <main class="min-h-screen py-10">
            <section>
                <div class="mx-5 lg:m-auto lg:w-2/3">
                    ...
                    <p class="text-center dark:text-slate-400 sm:text-xl lg:pt-10">
                        This is my school project at UTCoupe, a robotics
                        club for student at university of technology of Compiegne. The
                        goal is to search for an opponent robot and kick it out of the ring.
                    </p>
                </div>
            </section>
            <section>
                <div class="mx-5 grid pt-10 lg:mx-10 lg:grid-cols-2 lg:gap-4 lg:pt-52">
                    <div>
                        ...
                        <p class="pt-5 dark:text-slate-400 sm:text-xl">
                            Fascinating by finite machine methodology learned on TI-RSLK from
                            Texas Instrument,
                        ...
                        <button class="rounded-full bg-slate-500 px-4 py-2 font-bold text-white hover:bg-blue-700">
                            <a href="https://github.com/CaoKha/SumoRobot" target="_blank">
                ...
                <div class="mx-5 grid pt-10 lg:mx-10 lg:grid-cols-2 lg:gap-4 lg:pt-52">
                    <div>
                        <h1 class="mt-3 text-lg font-medium tracking-tight dark:text-slate-200 sm:text-2xl">
                            2: DESIGN FRONT PLATE FOR 3D
                            PRINTING
                        </h1>
                        <p class="pt-5 dark:text-slate-400 sm:text-xl">
                            Our robot need a front plate in order to attack the opponent.
